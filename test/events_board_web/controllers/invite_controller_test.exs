defmodule EventsBoardWeb.InviteControllerTest do
  use EventsBoardWeb.ConnCase

  alias EventsBoard.Invites

  @create_attrs %{resp: "some resp"}
  @update_attrs %{resp: "some updated resp"}
  @invalid_attrs %{resp: nil}
  ...
  describe "update invite" do
    ...
    test "redirects when data is valid", %{conn: conn, invite: invite} do
      ...
      assert html_response(conn, 200) =~ "some updated resp"
    end
